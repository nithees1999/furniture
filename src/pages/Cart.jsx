      ...
      <Container>
        <Row>
          <Col lg='9'>
            {
              cartItems.length === 0 ? (
                <h2 className="fs-4 text-center">No items added</h2>
              ) : (
          ...
          <Col lg="3">
            <div>
              <h3 className="d-flex align-items-center justify-content-between ">Subtotal
                <span className="fs-4 fw-bold">INR.{totalAmount}</span></h3>
